...
agent/commands/                    ← All ACP command docs (70 acp.* + 2 git.*)
...
/acp-route "Add loading skeleton to SampleList screen"
...
1. `/acp-route "Add loading skeleton to SampleList screen"`

...
- date: 2026-08-14
  task_type: audit-run
  mistake: "consumer-project upstream-port-guide treated acp-core manifest command-file count (67 vs 75) as proof six commands were missing upstream — integrity/review/sync/etc. were already byte-identical in ACP Enhanced."
  ...
  priority: high
  trigger: consumer-project-port-audit
...
- date: 2026-05-09
  ...
  mistake: >
    ...
    could be run. The consumer-project project (feedback-001) lost 3 sessions of work:

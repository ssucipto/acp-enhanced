...
carryovers:
  ...
  # ── AUDIT-114 FINDINGS — FIFOZ FEEDBACK UPSTREAM PORT (2026-08-14) ─────────
  - audit_id: 114
    finding_id: F-114-02
    severity: high
    file: agent/commands/acp.ci.md
    finding: "ACP Enhanced has no /acp-ci — routing.yml ci-check is a dangling stub; FIFOZ ships a working local CI parity command"
    description: "feedback-009 / port guide. Four verify commands exist but none predicts GitHub Actions. Port abstract orchestrator + preference schema; do not copy FIFOZ Expo/Firebase step bodies."
  ...
  - audit_id: 114
    ...
    finding: "/acp-pr missing upstream; FIFOZ v1.2.0 correctly delegates gates to /acp-ci"
  ...
  - audit_id: 114
    ...
    description: "FIFOZ regression concern. Register + sentinel assertion makes loss visible; prefer-upstream-when-superseded policy."
  ...
  - audit_id: 114
    ...
    severity: high
    file: agent/core/constraints.yml
    finding: "set +e does not suppress ERR trap — not documented in bash_rules (missing in AE and FIFOZ trees)"
  ...
  - audit_id: 114
    ...
    severity: medium
    file: agent/scripts/acp.review-scan.sh
    finding: "FIFOZ review-scan.sh diverged from AE M83 (+75/-7) with feedback-008 precision fixes"
    description: "acp.review.md identical; scanner script is not. Blind overwrite would lose either M83 or FIFOZ fixes."
    fix_target: "Diff-merge using agent/reports/fifoz-port-inbox-2026-08-14/acp.review-scan.sh.fifoz-vs-ae.diff; re-run review E2E corpus"
    status: fixed
    fix_applied_date: 2026-08-14
    ...
    fix_note: "Hunk-classified merge: take FIFOZ precision (8) + hybrid portability-check skip (1); kept AE M83 SC-15/flag-parse/corpus/rule_overrides."
  - audit_id: 114
    finding_id: F-114-07
    severity: high
  ...
  - audit_id: 115
    finding_id: F3-01
    severity: high
    file: agent/tasks/milestone-86-fifoz-field-feedback-port/task-309-acp-ci-orchestrator.md
  ...
  - audit_id: 115
    finding_id: F3-05
    severity: high
    file: agent/tasks/milestone-86-fifoz-field-feedback-port/task-321-v6310-closure.md
  ...
  - audit_id: 138
    ...
    finding: "FIFOZ-authored handoff proposal still tracked on public remote"
  ...
  - audit_id: 138
    ...
    severity: low
    file: README.md
    finding: "README still names FIFOZ in current-facing wave/M47/M50 copy"

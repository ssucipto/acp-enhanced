...
**Exemplar output (FIFOZ):** `agent/reports/design-spec-app-interfaces-m15-spine-v2.1.md`
...
Saved to: agent/reports/design-spec-app-interfaces-m15-spine-v2.1.md

Next: /acp-visualize --update  (view diagrams)
...
- [`/acp-visualize`](acp.visualize.md) — Render spec diagrams in Visualizer
...
**Solution**: Follow §19 traps; upgrade Visualizer; use `/acp-visualize --update`
